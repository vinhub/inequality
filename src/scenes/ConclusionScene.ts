...
export default class ConclusionScene extends Phaser.Scene
{
    ...
    create()
    {
        ...
        let actionButton: TextButton = this.add.existing(new TextButton(this, utils.leftX + (utils.rightX - utils.leftX) / 2, curY, 'Credits',
            () => { utils.sceneTransition(this, 'CreditsScene') }, true, true).setOrigin(0, 0)) as TextButton
